            ...
            <div className='flex w-[100%] items-center flex-col lg:flex-row justify-between md:w-[90%] lg:w-[70%] mt-[130px] md:mt-[180px] mb-[80px]'>
                <div className='md:h-[200px] md:w-[700px] mb-11 lg:mr-44 '>
                    ...
                    <div className='flex mt-10'>
                        <a href='https://drive.google.com/file/d/1I-gnZKiJ4xvJxmMwDDE3IA0f6vnIfdNG/view?usp=share_link' target='_blank' rel="noreferrer" className='font-[500] mr-3 w-[50%] bg-gray-800 text-white px-3 py-2 rounded-sm hover:cursor-pointer text-center transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300' >Resume</a>
