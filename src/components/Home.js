...
const Home = () => {
    return (
        <div name='home' className='h-[100%] px-4 w-[100%] lg:h-screen items-center flex justify-center  '>
            <div className='flex w-[100%] items-center flex-col lg:flex-row justify-between md:w-[90%] lg:w-[70%] mt-[130px] md:mt-[180px] mb-[80px]'>
                <div className='md:h-[200px] md:w-[700px] mb-11 lg:mr-44 '>
                    ...
                    <h2 className='text-xl md:text-2xl font-[600] text-[#fd7014] '>a <span className='text-black'>Software Developer | Open Source Contributor </span></h2>
                </div>
